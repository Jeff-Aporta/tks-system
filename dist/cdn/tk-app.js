import{css as h,define as c,html as r}from"./_shared.js";import{aviso as p,estado as s}from"./estado.js";import{api as o}from"./api.js";const m="(max-width: 48rem)",l=280,u=`
  :host {
    display: grid;
    overflow: hidden;
    height: 100dvh;
...
`;class f extends HTMLElement{static get observedAttributes(){return["full"]}#i;#t=null;#s=null;#a=null;#h=null;#e=null;#o=null;#n=null;#l=null;#r=!1;#d=null;#c=!1;#p=l;constructor(){super(),this.#i=this.attachShadow({mode:"open"}),h(this.#i,u)}connectedCallback(){s.leer().full&&this.setAttribute("full",""),this.#x(),this.#w(),addEventListener("popstate",()=>{this.#f()})}disconnectedCallback(){this.#l?.removeEventListener("change",this.#v)}get full(){return this.hasAttribute("full")}#v=()=>{this.#g(!!this.#l?.matches)};#g(t){this.toggleAttribute("compact",t),!t&&this.#r&&this.#u(),t||this.#m("rail");const i=this.#a;if(i)if(i.disabled=t,t){const a=Number(i.positionInPixels);Number.isFinite(a)&&a>0&&(this.#p=a),i.positionInPixels=0}else{const a=this.#p>0?this.#p:l;i.positionInPixels=a}}#m(t){if(!this.#t||!this.#s||!this.#h)return;const i=t==="rail"?this.#s:this.#h;this.#t.parentElement!==i&&i.appendChild(this.#t)}#b(){!this.#e||this.#r||(this.#m("drawer"),this.#e.show?.(),this.#e.setAttribute("open",""))}#u(){!this.#e||!this.#r||(this.#e.hide?.(),this.#e.removeAttribute("open"))}async#w(){s.leer().full&&this.setAttribute("full",""),this.full||await this.#k(),await this.#f()}async#k(){try{const{data:t}=await o.listarTodos();this.#t&&(this.#t.filas=t)}catch(t){p(`No se pudo cargar el cat\xE1logo: ${t instanceof Error?t.message:t}`,"danger")}}async#f(){const{tk:t,space:i}=s.leer();if(this.#t&&(this.#t.seleccionado=t??""),!t){this.#d&&(this.#d.ticket=null),this.#n&&(this.#n.ticket=null);return}await this.#y(t,i??"patyia")}async#y(t,i){if(this.#c)return;this.#c=!0;const a=this.#i.querySelector(".visor");a?.replaceChildren(r`
      <div class="cargando">
        <is-spinner aria-hidden="true"></is-spinner>
        Cargando ${t}…
      </div>
    `);try{const{data:e}=await o.ticket(i,t);this.#d=Object.assign(document.createElement("tk-view"),{ticket:e}),this.#n&&(this.#n.ticket=e),a?.replaceChildren(this.#d),document.title=`${e.iticket} \xB7 ${e.titulo??"Tiquete"}`}catch(e){this.#n&&(this.#n.ticket=null),a?.replaceChildren(r`
        <div class="cargando">
          <is-callout color="danger" icon="mdi:alert-circle-outline">
            No se pudo abrir ${t}: ${e instanceof Error?e.message:String(e)}
          </is-callout>
        </div>
      `)}finally{this.#c=!1}}#x(){for(;this.#i.firstChild;)this.#i.removeChild(this.#i.firstChild);const t=document.createElement("div");if(t.className="visor",this.full){this.#i.append(t);return}this.#t=document.createElement("tk-nav"),this.#t.addEventListener("tk-seleccion",e=>{const{iticket:n,space:d}=e.detail;s.escribir({tk:n,space:d}),this.#f(),this.#u()}),this.#n=document.createElement("tk-actions"),this.#s=document.createElement("aside"),this.#s.className="rail",this.#s.slot="start",this.#s.setAttribute("aria-label","Cat\xE1logo de tiquetes"),this.#s.appendChild(this.#t),t.slot="end",this.#a=document.createElement("is-split-panel"),this.#a.className="split",this.#a.setAttribute("orientation","horizontal"),this.#a.setAttribute("primary","start"),this.#a.setAttribute("position-in-pixels",String(l)),this.#a.setAttribute("storage-key","tk-app-nav"),this.#a.append(this.#s,t),this.#i.append(r`
      <header>
        <is-button
          class="nav-btn"
          variant="plain"
    ...
    `),this.#o=this.#i.querySelector(".nav-btn"),this.#e=this.#i.querySelector("#navDrawer"),this.#h=this.#i.querySelector(".drawer__mount"),this.#i.querySelector(".filtros")?.addEventListener("is-tab-show",e=>{const n=String(e.detail?.name??"all");this.#t&&(this.#t.contexto=n)}),this.#o?.addEventListener("click",()=>{this.#r?this.#u():this.#b()}),this.#e?.addEventListener("is-show",()=>{this.#r=!0,this.#o?.setAttribute("aria-expanded","true"),queueMicrotask(()=>{this.#t?.shadowRoot?.querySelector("input, is-input")?.focus?.()})});const a=()=>{this.#r=!1,this.#o?.setAttribute("aria-expanded","false"),this.#m("rail")};this.#e?.addEventListener("is-after-hide",a),this.#e?.addEventListener("is-hide",()=>{this.#r&&a()}),this.#l=matchMedia(m),this.#l.addEventListener("change",this.#v),this.#g(this.#l.matches)}}c("tk-app",f);
