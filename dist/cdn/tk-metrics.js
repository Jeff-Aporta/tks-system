import{css as k,define as w,fecha as b,html as r,minutos as x,rec as a}from"./_shared.js";const S=`
  :host {
    display: block;
    width: 100%;
    max-width: 100%;
...
`,M=s=>{const i=a(s.detallesExtra),e=a(s.meta),n=a(i.metricas),c={...a(e.metricas),...n},l=a(c.documentacion);return l.metricasHabilesMinutos&&!c.metricasHabilesMinutos&&(c.metricasHabilesMinutos=a(l.metricasHabilesMinutos)),c},d=s=>{const i=Number(s);return Number.isFinite(i)&&i>0?Math.round(i):0},v=s=>{const i=Number(s);return Number.isFinite(i)&&i>0?Math.round(i*60):0},$=(s,i)=>{const e=a(i.metricasHabilesMinutos),n=a(i.documentacion),o=a(n.metricasHabilesMinutos),c=d(e.hastaAtencion??o.hastaAtencion)||d(s.diligenciaMinutos),l=a(i.reporteEmpresa),p=d(e.atencionActiva??o.atencionActiva)||v(l.horasAtencion),m=d(e.totalSolucion??o.totalSolucion??s.tiempoTotalMinutos)||v(l.horasSolucion)||d(s.tiempoEstimacionMinutos)||c+p+d(s.commitMinutos);return[{icon:"mdi:clock-start",label:"Hasta atenci\xF3n",minutos:c,sub:"Creaci\xF3n \u2192 inicio atenci\xF3n"},{icon:"mdi:head-cog-outline",label:"Atenci\xF3n activa",minutos:p,sub:"Inicio atenci\xF3n \u2192 cierre"},{icon:"mdi:check-decagram",label:"Total soluci\xF3n h\xE1bil",minutos:m,sub:"Tiempo real laborado / estimado"}]};class C extends HTMLElement{#e=null;#i;constructor(){super(),this.#i=this.attachShadow({mode:"open"}),k(this.#i,S)}connectedCallback(){this.#t()}get ticket(){return this.#e}set ticket(i){this.#e=i,this.isConnected&&this.#t()}#t(){for(;this.#i.firstChild;)this.#i.removeChild(this.#i.firstChild);const i=this.#e;if(!i?.iticket){this.#i.append(r`<p class="vacio">Sin tiquete para métricas.</p>`);return}const e=M(i),n=a(e.documentacion),o=a(e.reporteEmpresa),c=$(i,e),l=[...i.tiempos??[]].filter(t=>Number(t.minutos??0)>0),p=!e.fechaCierre&&String(n.cierreEmpresa??i.estado??"").toLowerCase().includes("abierto")||!e.fechaCierre&&!i.fechaEntrega,m=String(n.tipoSolicitudApertura??a(i.normativa).tipoSolicitudApertura??a(i.normativa).tipoSolicitud??"").trim(),u=[];e.fechaCreacion?(p||!e.fechaCierre)&&u.push(r`
      ...
      `);const g=[["Creaci\xF3n",e.fechaCreacion||b(i.fechaSolicitud,!0)||"\u2014"],["Inicio atenci\xF3n",e.horaInicioAtencion||"\u2014"],["Cierre",e.fechaCierre||b(i.fechaEntrega,!0)||"Abierto"],["Tipo apertura",m||"\u2014"],["Asignado",String(n.asignadoA||n.ingeniero||"\u2014")],["Solicitante",String(n.solicitante||i.solicitante||"\u2014")],["Clasificador",String(n.clasificador||"\u2014")],["Medio",String(n.medioAtencion||"\u2014")]].filter(([,t])=>String(t).trim()&&String(t)!=="\u2014"),f=[["Horas atenci\xF3n (empresa)",o.horasAtencion!=null?`${o.horasAtencion} h`:""],["Horas soluci\xF3n (empresa)",o.horasSolucion!=null?`${o.horasSolucion} h`:""],["Capturado",String(o.capturado||"")],["Fuente",String(o.fuente||"")]].filter(([,t])=>String(t).trim());this.#i.append(r`
