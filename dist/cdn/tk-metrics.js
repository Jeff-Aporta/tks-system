...
`,$=s=>{const i=a(s.detallesextra),e=a(s.meta),n=a(i.metricas),c={...a(e.metricas),...n},l=a(c.documentacion);return l.metricasHabilesMinutos&&!c.metricasHabilesMinutos&&(c.metricasHabilesMinutos=a(l.metricasHabilesMinutos)),c},d=s=>{const i=Number(s);return Number.isFinite(i)&&i>0?Math.round(i):0},v=s=>{const i=Number(s);return Number.isFinite(i)&&i>0?Math.round(i*60):0},M=(s,i)=>{const e=a(i.metricasHabilesMinutos),n=a(i.documentacion),o=a(n.metricasHabilesMinutos),c=d(e.hastaAtencion??o.hastaAtencion)||d(s.diligenciaMinutos),l=a(i.reporteEmpresa),p=d(e.atencionActiva??o.atencionActiva)||v(l.horasAtencion),m=d(e.totalSolucion??o.totalSolucion??s.tiempoTotalMinutos)||v(l.horasSolucion)||d(s.tiempoestimacionminutos)||c+p+d(s.commitminutos);return[{icon:"mdi:clock-start",label:"Hasta atenci\xF3n",minutos:c,sub:"Creaci\xF3n \u2192 inicio atenci\xF3n"},{icon:"mdi:head-cog-outline",label:"Atenci\xF3n activa",minutos:p,sub:"Inicio atenci\xF3n \u2192 cierre"},{icon:"mdi:check-decagram",label:"Total soluci\xF3n h\xE1bil",minutos:m,sub:"Tiempo real laborado / estimado"}]};class C extends HTMLElement{#e=null;#i;constructor(){super(),this.#i=this.attachShadow({mode:"open"}),k(this.#i,S)}connectedCallback(){this.#t()}get ticket(){return this.#e}set ticket(i){this.#e=i,this.isConnected&&this.#t()}#t(){for(;this.#i.firstChild;)this.#i.removeChild(this.#i.firstChild);const i=this.#e;if(!i?.iticket){this.#i.append(r`<p class="vacio">Sin tiquete para métricas.</p>`);return}const e=$(i),n=a(e.documentacion),o=a(e.reporteEmpresa),c=M(i,e),l=[...i.tiempos??[]].filter(t=>Number(t.minutos??0)>0),p=!e.fechaCierre&&String(n.cierreEmpresa??i.estado??"").toLowerCase().includes("abierto")||!e.fechaCierre&&!i.fechaentrega,m=String(n.tiposolicitudapertura??a(i.normativa).tiposolicitudapertura??a(i.normativa).tipoSolicitud??"").trim(),u=[];e.fechaCreacion?(p||!e.fechaCierre)&&u.push(r`
